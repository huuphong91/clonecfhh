...
public class NewsAdapterNews extends RecyclerView.Adapter<NewsAdapterNews.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView title_for_news, title_bold_for_news;
        public ImageView thumbnail_news;

        public MyViewHolder(View view) {
            super(view);
            title_bold_for_news = view.findViewById(R.id.title_bold_news);
            thumbnail_news = view.findViewById(R.id.thumbnail_for_news);
            title_for_news = view.findViewById(R.id.title_for_news);
        }
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Glide.with(mContext).load(album.getImage()).into(holder.thumbnail_news);
