...
public class DataItem implements Parcelable {
    ...
    protected DataItem(Parcel in) {
        ...
        highResImage = in.readString();
        updatedAt = in.readString();
        price = in.readInt();
        basePrice = in.readInt();
        id = in.readString();
        imageId = in.readInt();
        codes = in.createStringArrayList();
    }
    ...
    public void setToppingList(List<ToppingListItem> toppingList) {
        this.toppingList = toppingList;
    }

    public List<ToppingListItem> getToppingList() {
        return toppingList;
    }
